        ...
        <div className="flex flex-col justify-center items-center px-4 sm:px-12 lg:px-24 py-12 bg-white relative">
          <div className="w-full max-w-md space-y-8">
            <div className="text-center lg:text-left">
              ...
              <p className="mt-2 text-gray-500">Sign in to your OneHubGlobal account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-end">
                <Link href="/forgot-password" className="text-sm font-medium text-[#0ea5e9] hover:text-sky-700">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="text-center mt-6">
              <p className="text-gray-600">
                ...
                <Link href="/signup" className="font-bold text-[#0ea5e9] hover:text-sky-700">
                  Sign up
                </Link>
              </p>
            </div>
