      ...
      < div className="absolute inset-0 z-0 w-full h-full pointer-events-none" >
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full h-full animate-swell" style={{ animationDuration: '5s', animationDelay: '-2s', transform: 'scaleY(1.3)', transformOrigin: 'bottom' }}>
            <div className="absolute bottom-0 left-0 w-[200%] h-full animate-wave" style={{ animationDuration: '15s' }}>
              <svg
                viewBox="0 0 1440 320"
                className="w-full h-full block"
                preserveAspectRatio="none"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              <div className="flex items-center justify-center w-10 h-10 rounded-full overflow-hidden bg-white/10 backdrop-blur-sm">
                <Image
                  src="/logo_new.jpg"
                  alt="OHG365 Logo"
                  width={40}
            ...
            <div className="flex space-x-3">
              {socialLinks.map((social) => (
                <Link
                  key={social.name}
                  href={social.href}
                  className="w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-300 hover-lift hover:text-white group relative overflow-hidden bg-white/10 backdrop-blur-sm"
                  style={{
